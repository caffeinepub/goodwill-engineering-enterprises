      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight">
            The <span className="text-primary">Goodwill</span> <span className="text-accent">Experience</span>
          </h2>
          ...
          <div className="pt-8 space-y-4">
            <p className="text-lg text-muted-foreground leading-relaxed">
              We understand that <span className="text-accent">reliability</span> and <span className="text-primary">performance</span> are critical in industrial applications.
            </p>
            <p className="text-xl font-semibold text-foreground">
              That's why we focus on quality, expertise, and product authenticity.
            </p>
          </div>
        </div>
      </div>
