...
import { CheckCircle2, Copy, Globe, Mail, Save, Sparkles } from "lucide-react";
import { useEffect, useState } from "react";
import { toast } from "sonner";
import {
  useGetCompanyContactGmail,
  useGetCustomDomainRequest,
  useSetCustomDomainRequest,
  useUpdateCompanyContactGmail,
...
export function AdminSettingsTab() {
  const { data: gmailAddress, isLoading: gmailLoading } =
    useGetCompanyContactGmail();
  const updateGmailMutation = useUpdateCompanyContactGmail();
  const [localGmail, setLocalGmail] = useState("");

  const { data: customDomain, isLoading: domainLoading } =
    useGetCustomDomainRequest();
  ...
  const showSuggestedDomainButton =
    !customDomain && localDomain !== SUGGESTED_DOMAIN;
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manage your company contact information. This is stored for
            reference only. The app does not send emails.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              This email address is displayed for reference. No automated emails
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              disabled={
                updateGmailMutation.isPending || localGmail === gmailAddress
              }
            >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set up your custom .com domain to use with this site. You'll need to
        ...
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            {!customDomain && (
              <p className="text-sm text-muted-foreground">
                No custom domain saved yet. Enter your domain above and click
                Save.
              </p>
            )}
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            {showSuggestedDomainButton && (
              <Button variant="outline" onClick={handleUseSuggestedDomain}>
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-lg font-semibold mb-2">
                How to link your domain
              </h3>
              <p className="text-sm text-muted-foreground mb-4">
                Follow these steps to point your custom domain to this site.
                You'll need to log in to your domain registrar (e.g., GoDaddy,
            ...
            <div className="space-y-4 bg-muted/50 p-4 rounded-lg">
              <div className="space-y-2">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Access the DNS management section for your domain (e.g.,
                      yourbrand.com).
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    <p className="text-sm font-medium">
                      Optional: Add an A record for root domain
                    </p>
                    <p className="text-sm text-muted-foreground">
                      If you want yourbrand.com (without www) to work, add an A
                      record or use domain forwarding to redirect to
                      www.yourbrand.com.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      DNS changes can take anywhere from a few minutes to 48
                      hours to propagate worldwide. Be patient!
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-900 p-4 rounded-lg">
              <p className="text-sm text-blue-900 dark:text-blue-100">
                <strong>Note:</strong> This app does not automatically purchase
                or configure domains. You must buy your domain from a registrar
                and manually configure the DNS settings as described above.
              </p>
            </div>
          </div>
        </CardContent>
