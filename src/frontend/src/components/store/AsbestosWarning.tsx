  ...
  if (variant === "info") {
    return (
      <Alert>
        ...
        <AlertDescription>
          Your cart contains asbestos products. Please ensure you understand the
          safety requirements and handling procedures before proceeding.
        </AlertDescription>
      </Alert>
    );
  }
  ...
  return (
    <Alert variant="destructive">
      ...
      <AlertDescription className="space-y-2">
        <p>
          This product contains asbestos. Asbestos fibers can cause serious
          health issues including lung disease and cancer when inhaled.
        </p>
        ...
        <p className="font-semibold">
          By purchasing this product, you acknowledge these risks and agree to
          handle it safely and in compliance with all applicable regulations.
        </p>
      </AlertDescription>
    </Alert>
  );
