...
export function ContactCtaSection() {
  const { data: companyGmail, isLoading: gmailLoading } =
      ...
      <div className="container">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
            Whether you need lubricants, mechanical packing, fluid sealants, or
            specialized sealing solutions — we've got the products that deliver
                ...
                <CardDescription className="text-base space-y-3">
                  ...
                  <div className="space-y-1">
                    <Button
                      ...
                      className="text-accent hover:text-accent/80 text-base font-semibold p-0 h-auto"
                    >
                      <a href={`tel:${CONTACT_CONFIG.phone2}`}>
