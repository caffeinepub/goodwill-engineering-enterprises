...
export function HeroSection() {
  ...
  return (
    <section 
      ...
      style={{
        backgroundImage: 'url(/assets/generated/gaskets-sealants-hero-bg-white-text.dim_1920x1080.png)',
      ...
      <div className="container relative z-10 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white">
            ...
            <br />
            <span className="text-primary">Sealing Solutions Without Compromise.</span>
          </h1>
          
          {/* Subheading - White with slight opacity */}
          <p className="text-lg md:text-xl text-white/90 max-w-3xl mx-auto leading-relaxed">
            Your trusted source for premium lubricants, mechanical packing, fluid sealants, brake liners, 
            ceramic fibre & glass products, and professional-grade gland packings.
          </p>
